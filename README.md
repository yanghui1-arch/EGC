...
**2026-09-24真实结果：** 用户先完成Qwen3-1.7B全参三组，数据4757/528，均527/528有效。共同有效526案MAE direct15.19、flat13.99、bound14.23月：证据组有信号，绑定优势未获支持；不能替代完整集评估。见[结果及局限](docs/QWEN17_DEV_RESULT.md)。下一步按既定Qwen2.5-7B LoRA同包复核，尚未运行，不重做数据。
